...
arcpy.stats.HotSpots(
    Input_Feature_Class="Gap_Poor",
    Input_Field="GapCP",
    Output_Feature_Class=r"C:\Users\hxl786\Dropbox\Working File\Working Papers\Gao23_Solar School\Solar School_0919\Default.gdb\GPCHotSpots",
