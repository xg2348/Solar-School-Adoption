...
arcpy.stats.HotSpotAnalysisComparison(
    ...
    in_hot_spot_2="GNWHotSpots",
    out_features=r"C:\Users\hxl786\Dropbox\Working File\Working Papers\Gao23_Solar School\Solar School_0919\Default.gdb\NWComparison",
    num_neighbors=8,
    num_perms=999,
